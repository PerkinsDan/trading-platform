const ORDER_PROCESSOR_BASE_URL = import.meta.env.VITE_APP_ORDER_PROCESSOR_BASE_URL;
...
export const UPDATE_USER_BALANCE_ENDPOINT = `${ORDER_PROCESSOR_BASE_URL}/users/update-user-balance`;
