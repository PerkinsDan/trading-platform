const ORDER_PROCESSOR_BASE_URL =
  import.meta.env.VITE_APP_ORDER_PROCESSOR_BASE_URL ||
  process.env.VITE_APP_ORDER_PROCESSOR_BASE_URL;
...
const MARKET_DATA_BASE_URL =
  import.meta.env.VITE_APP_MARKET_DATA_BASE_URL ||
  process.env.VITE_APP_MARKET_DATA_BASE_URL;
