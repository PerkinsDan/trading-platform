...
public class OrderProcessor{
    ...
    private static BlockingQueue<Order> orderQueue = null; // thread safe queue, supports take() which checks that the queue is empty before doing anything, and will wait if it is
