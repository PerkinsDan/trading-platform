...
OrderComparatoris used in the TradeBook class, the TradeBook class uses 
...
compare (Order order1, Order order2) int : Compares any two orders and returns either or -1 to determine which Order comes first in the queue.
