...
* getOrderID() : returns orderID atttribute
* getPrice() : returns price atttribute
* getQuantityChange() : return quantityChange atttribute
* isFilled() : returns True/False if order has been filled or not
